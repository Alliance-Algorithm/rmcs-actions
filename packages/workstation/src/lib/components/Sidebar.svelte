...
<SidebarButton breakpoint="lg" onclick={sidebarUi.toggle}
               class="inline-flex items-center text-sm rounded-lg
                      hover:bg-gray-100 focus:outline-hidden focus:ring-2
                      focus:ring-gray-200 dark:hover:bg-gray-700 dark:focus:ring-gray-600
                      lg:hidden fixed top-2 z-40 mb-2 md:top-6" />
<Sidebar
  breakpoint="lg"
  backdrop={false}
  {isOpen}
  ...
  class="top-0 left-0 mt-[61px] md:mt-[90px] lg:mt-[92px] h-screen w-64 bg-gray-50 transition-transform lg:block dark:bg-gray-800 border-r border-gray-200"
