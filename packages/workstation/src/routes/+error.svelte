...
<div
  class="max-w-xl w-full bg-white dark:bg-gray-800 shadow-md rounded-lg p-8 mx-auto my-16 self-center"
>
  <div class="flex items-start gap-4">
    <div class="flex-1">
      <h1 class="text-2xl font-semibold text-gray-900 dark:text-gray-100">Something went wrong</h1>
      <p class="mt-2 text-sm text-gray-600 dark:text-gray-300">
        Sorry — we ran into an unexpected problem while loading this page.
      </p>
      ...
      <div class="mt-4" role="alert" aria-live="assertive">
        ...
        >
          ...
          <span class="px-2 py-0.5 text-xs bg-red-100 dark:bg-transparent text-red-800 rounded"
            >{page.status}</span
          >
        </div>
